        ...
        <div className="flex flex-col gap-6 md:flex-row md:items-center">
          ...
          <div className="space-y-2">
            ...
            <p className="text-sm font-medium text-muted-foreground max-w-lg">
              Tambahkan lokasi kantor baru dan atur titik koordinat geofencing untuk sistem absensi.
            </p>
          </div>
        </div>
      ...
      <div className="grid gap-8">
        <Card className="overflow-hidden rounded-3xl border-none shadow-md ring-1 ring-border">
          <CardHeader className="bg-muted/30 px-8 py-6">
            <CardTitle className="text-xl">Office Registration Form</CardTitle>
            <CardDescription>
              Tentukan koordinat Latitude dan Longitude dengan presisi untuk akurasi check-in.
            </CardDescription>
          </CardHeader>
